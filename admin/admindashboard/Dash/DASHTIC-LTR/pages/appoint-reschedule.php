                                    ...
                                    <form method="POST" action="">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="brand" disabled>
                                                <option value="<?=$appoint['brand_id'];?>" selected><?=$appoint['brand_name'];?></option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Model Name</label>
                                            <select class="form-control" name="model" disabled>
                                                <option value="<?=$appoint['model_id'];?>"><?=$appoint['model_name'];?></option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">First Name</label>
                                            <input type="text" class="form-control" name="firstname" value="<?=$appoint['first_name'];?>" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Last Name</label>
                                            <input type="text" class="form-control" name="lastname" value="<?=$appoint['last_name'];?>" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Email</label>
                                            <input type="email" class="form-control" name="email" value="<?=$appoint['email'];?>" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Datetime *</label>
                                            <input id="appointment_date" class="form-control" name="schedule" value="<?=$appoint['appointment_schedule'];?>" required>
                                        </div>
                                        <div class="form-group">
