...
?>
												<form action="" method= "post">
													...
													<div class="row">
														<div class="col-12">
															<button type="submit" class="btn btn-lg btn-primary btn-block" onclick="return forgotpassword();">Reset Password</button>
														</div>
													</form>
												</div>
											</div>
										...
										<div class="card text-white bg-primary py-5 d-md-down-none page-content mt-0">
											<div class="card-body text-center justify-content-center page-single-content">
												<img src="<?php echo $root?>../public/assets/images/pattern/login.png" alt="img">
											</div>
										</div>
									</div>
		...
		<script>
			function forgotpassword() {
				var dialog = "A new generated password will be sent to your email. Kindly, change your password once you login with generated password.";
