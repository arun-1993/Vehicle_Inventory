...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    else
    {
        ...
        try {
            ...
            $mail->Body    = "Hello,<br />Your autogenerated password is $password <br>"; 
            
            $mail->AltBody = "Hello, your autogenerated password is $password";
            $mail->send();
...
{
    echo '<div class="alert alert-danger" role="alert"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>Invalid Username / Password!</div>';
}	
...
?>
		...
		<script>
			function forgotpassword() {
				var dialog = "Your password will be reset and a new password will be sent to your email.\nPlease do not forget to change your password once you log in with the generated password";
