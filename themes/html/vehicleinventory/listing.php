            ...
            <div class="car-image">
            <img class="img-fluid" src="<?php echo $root?>/images/car/<?php echo $row['vehicle_image'];?>" alt="">
            </div>
            </div>
            </div>
            ...
            <div class="car-title">
            <a href="<?php echo $root;?>/single.php?vehicle=<?php echo $row['vehicle_id']; ?>"><?php echo $row['brand_name'].'&nbsp&nbsp;'.$row['model_name']; ?></a>
