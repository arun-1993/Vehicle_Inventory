          ...
          <ul>
          <li><a href="<?php echo $root;?>/single.php?vehicle=<?php echo $feturedcarrow['vehicle_id']; ?>"><i class="fa fa-link"></i></a></li>
          ...
          <a href="<?php echo $root;?>/single.php?vehicle=<?php echo $feturedcarrow['vehicle_id']; ?>"> <?php echo $feturedcarrow['brand_name'].'&nbsp&nbsp;'.$feturedcarrow['model_name']; ?></a>
          <div class="separator"></div>
          <div class="price">
