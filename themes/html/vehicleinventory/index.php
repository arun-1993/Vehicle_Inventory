                                  ...
                                  <div class="row">
                                      <div class="col-md-6">
                                          ...
                                          <div class="selected-box">
                                              <select data-target="#search_form" class="selectpicker" name="brand"
                                                  id="brand" onchange="fetch_models(this.form)">
                      ...
                      <div class="row no-gutter justify-content-center">
                          <div class="col-lg-3 col-md-4 col-sm-6 px-2">
                              <div class="link text-center">
                                  <a href="<?php echo $root; ?>/listing.php?condition=1">
                                      <i class="fa fa-car"></i>
                                      <h6>New Vehicles</h6>
                                  </a>
                              </div>
                          ...
                          <div class="col-lg-3 col-md-4 col-sm-6  ">
                              <div class="link text-center">
                                  <a href="<?php echo $root; ?>/listing.php?condition=2">
                                      <i class="fa fa-car"></i>
                                      <h6>Used Vehicles</h6>
                                  </a>
                              </div>
                          ...
                          <div class="col-lg-3 col-md-4 col-sm-6 px-2">
                              <div class="link text-center">
                                  <a href="<?php echo $root; ?>/listing.php">
                          ...
                          <div class="col-lg-3 col-md-4 col-sm-6 px-2">
                              <div class="link text-center">
                                  <a href="<?php echo $root; ?>/contactus.php">
...
?>
          ...
          feature-car section start -->
              ...
              <section class="feature-car white-bg " style="padding-bottom:30px">
                  <div class="container">
                      <div class="row">
                          <div class="col-md-12">
                              ...
                              <div class="owl-carousel owl-theme" data-nav-arrow="true" data-items="3" data-md-items="4"
                                  ...
                                  <div class="item">
                                      <div class="car-item car-item-4 text-center">
                                          <div class="car-image">
                                              <img class="img-fluid"
                                                  src="<?php echo $root; ?>/images/car/<?php echo $feturedcarrow['vehicle_image']; ?>"
                                                  alt="" style="height:200px;width:auto">
                                              <div class="car-overlay-banner">
                                                  <ul>
                                                      <li><a
                                                              href="<?php echo $root; ?>/single.php?vehicle=<?php echo $feturedcarrow['vehicle_id']; ?>"><i
                                          ...
                                          <div class="car-list">
                                              <ul class="list-inline">
                                                  <li><i class="fa fa-registered"></i>
                                                      <?php echo $feturedcarrow['model_year']; ?></li>
                                                  <li><i class="fa fa-cog"></i>
                                                      <?php echo strtok($feturedcarrow['transmission_type'], " "); ?>
                                                  </li>
                                                  <li><i class="fa fa-shopping-cart"></i>
                                                      <?php echo $feturedcarrow['kms_driven'] > 0 ? 'Used' : "New"; ?>
                                                  </li>
                                              </ul>
                                          </div>
                                          <div class="car-content">
                                              <a
                                                  href="<?php echo $root; ?>/single.php?vehicle=<?php echo $feturedcarrow['vehicle_id']; ?>">
                                                  <?php echo $feturedcarrow['brand_name'] . '&nbsp&nbsp;' . $feturedcarrow['model_name']; ?></a>
                                              <div class="separator"></div>
                                              <div class="price">

                                                  <span
                                                      class="new-price"><?php echo indMoneyFormat($feturedcarrow['vehicle_price']); ?></span>
                                              </div>
                                          </div>
                                      </div>
                                  </div>
                      ...
                      <div class="row">
                              ...
                              <div class="feature-box-2 box-hover ">
                                  ...
                                  <div class="content">
                                      ...
                                      <p class="mb-0">Sed ut perspiciatis unde omnis iste natus error sit voluptatem
                                          acantium doloremque laudantium.</p>
                                  </div>
                              </div>
                          </div>
                          ...
                          <div class="col-md-4 col-sm-6">
                              <div class="feature-box-2 box-hover">
                                  ...
                                  <div class="content">
                                      <h5>Affordable</h5>
                                      <p class="mb-0">Perspiciatis sed ut unde omnis iste natus error sit voluptatem
                                          acantium doloremque laudantium.</p>
                                  </div>
                              </div>
                          </div>
                          <div class="col-md-4 col-sm-6">
                              <div class="feature-box-2 box-hover">
                                  ...
                                  <div class="content">
                                      <h5>transmission </h5>
                                      <p class="mb-0">Omnis perspiciatis sed ut unde iste natus error sit voluptatem
                                          acantium doloremque laudantium. </p>
                                  </div>
                              </div>
                          </div>
                              ...
                              <div class="col-lg-3 col-sm-6 item">
                                  <div class="counter-block text-start">
                                      ...
                                      <div class="info">
                                          ...
                                          <b class="timer text-white" data-to="<?php echo $numbrand['num']; ?>"
                                              data-speed="3000"></b>
                                      </div>
                                  </div>
                              </div>
                              <div class="col-lg-3 col-sm-6 item">
                                  <div class="counter-block text-start">
                                      ...
                                      <div class="info">
                                          ...
                                          <b class="timer text-white" data-to="<?php echo $nummodel['num']; ?>"
                                              data-speed="3000"></b>
                                      </div>
                                  </div>
                              </div>
                              <div class="col-lg-3 col-sm-6 item">
                                  <div class="counter-block text-start mb-0">
                                      ...
                                      <div class="info">
                                          ...
                                          <b class="timer text-white" data-to="<?php echo $numappointment['num']; ?>"
                                              data-speed="3000"></b>
                                      </div>
                                  </div>
                              </div>
                              <div class="col-lg-3 col-sm-6 item">
                                  <div class="counter-block text-start">
                                      ...
                                      <div class="info">
                                          ...
                                          <i class="glyph-icon flaticon-beetle"></i>
                                          <b class="timer text-white" data-to="<?php echo $numvehicle['num']; ?>"
                                              data-speed="3000"></b>
                                      </div>
                                  </div>
                              </div>
                          ...
                          <div class="col-md-12">
                              ...
                              <div class="flex mx-auto" style="width:50% ;text-align:center">
                                  ...
                                  <P>AutoTrack is your single stop for buying used and fresh vehicles, all over India.
                                      We've brought together cutting-edge technology with country-wide partners and more
                                      importantly, deep understanding of what buyers need. We solve all pain points
                                      associated with purchasing a pre-loved one. Whether you're buying or selling, you
                                      get a quick, easy, fair, transparent, hassle (and haggle) free process.
